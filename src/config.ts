...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"在德国读书，也把路上的风景和代码一起记下来",
				"日本旅行、动漫巡礼、留学日常与一点技术折腾",
				"从校园到车站，从 VPS 到 HarmonyOS，慢慢写成手札",
				"把喜欢的作品、走过的城市和踩过的坑都收藏在这里",
			],
			typewriter: {
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/343181454",
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/zxykevin",
		},
		{
			name: "Discord",
			icon: "fa7-brands:discord",
			url: "https://discord.com/channels/1363226116097183927/1502796480048791573",
		},
	],
};
